...
function BannerCard({ b }: { b: Banner }) {
  ...
  return (
    <Link
      href={b.href}
      className="unstyled group relative min-h-[170px] overflow-hidden rounded-md p-5 text-white shadow-raised"
    >
      <div
        aria-hidden
    ...
    <section className="container-app pt-8">
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
        ...
        <div className="group relative min-h-[170px] overflow-hidden rounded-md shadow-raised">
          ...
          />
          <div aria-hidden className="absolute inset-0 bg-gradient-to-t from-brand/35 to-transparent" />
        </div>
